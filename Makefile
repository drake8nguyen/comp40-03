...
ppmtrans: ppmtrans.o cputiming.o a2plain.o a2blocked.o \
	uarray2b.o uarray2.o file_helpers.o apply_functs.o run_transform.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)


array2b: test.o uarray2b.o uarray2.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
